...
namespace MauiBlazor.Helpers
{
    internal static class NotificationHelper
    {
        ...
        public static void ShowErrorMessage(Exception exception) => Application.Current.MainPage.DisplayAlert("Error", $"Something went wrong: {exception.Message}", "OK");

        public static async Task ShowSnackMessage(string message, long durationMs = 2000)
        {
